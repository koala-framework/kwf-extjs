...
Ext.define('KwfExt.form.field.File', {
    extend: 'Ext.form.field.Base',
    requires: [
        'Ext.XTemplate',
        'Ext.button.Button',
        'KwfExt.data.UploadsModel'
    ],
    ...
    {
        this.uploadButton = new Ext.button.Button({
        ...
        this._fileInput.onchange = Ext.bind(function() {
        ...
        this._fileDrop.ondrop = Ext.bind(function(e) {
    ...
    _uploadFile: function(file)
    {
        ...
        xhr.onload = Ext.bind(function(e) {
            if (xhr.status == 200) {
                var r = xhr.response;
        ...
        xhr.open('POST', KwfExt.data.UploadsModel.prototype.getProxy().url, true);
    ...
    setValue: function(value)
    {
        if (value && this.rendered) {
            ...
            KwfExt.data.UploadsModel.load(value, {
                success: function(upload) {
                    ...
                    if (upload.get('mime_type')) {
                        ...
                        var infoVars = Ext.clone(upload.data);
                        infoVars.href = href;
